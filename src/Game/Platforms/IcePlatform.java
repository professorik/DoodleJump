...
public class IcePlatform extends PlatformPrototype {

    public IcePlatform(int height, boolean isMotion) {
        this.height = height;
        rectangle = new Rectangle(80 , 20);
        imageView = new ImageView(new Image("/resources/doodle_platforms_ice.png", 90 , 80 , true ,true, false));
